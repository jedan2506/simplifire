...
<head>
    ...
    <title>Simplifire | Conference</title>
    <style>
        .overlay {
            position: fixed;
            top: 0;
...
<?php include 'header.php' ?>
    <br>
        <form action="conferenceshow.php" method="post">  
...
<!--                     <input type="checkbox" class="selection" name="selection[]" value="organized"><label>Organized by</label>
                    ...
                    <input type="checkbox" class="selection" name="selection[]" value="type1"><label>Type</label>
